...
import { mockAgents, type OpenClawAgent } from './openClawData';
...
export function TalentMarket() {
  ...
  }, [statusFilter, hwFilter, tcrFilter]);
    ...
    <section className="py-10">
      <div className="container">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8 p-4 rounded-xl bg-white/5 border border-white/10">
          ...
          <span className="text-xs text-muted-foreground ml-auto">{filtered.length} 个结果</span>
        </div>
